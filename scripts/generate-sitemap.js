...
// postsデータを読み込み（動的インポートの代わりにrequireを使用）
const postsModule = require('../data/posts.ts');
const posts = postsModule.posts || [];
const getCategorySlugMap = postsModule.getCategorySlugMap || (() => ({}));
...
${allPages.map(page => `  <url>
  ...
  console.log(`\n⚠️  Remember to update DOMAIN in scripts/generate-sitemap.js before production!`);
}
